...
<center><h1>Lista Fichas</h1></center>

<button type="button" class="btn btn-primary"><a style="color:white;" href="{{url('fichas\create')}}">Nueva Ficha</a></button>
    ...
    <tbody>
        @foreach ($fichas as $ficha)
            <tr>
                ...
                <td>
                    @foreach ($ficha->programa()->get() as $f)
                        {{$f->Nombre}}
                    @endforeach
                </td>
                <td>
                    <form action="{{url('fichas/'.$ficha->IdFicha)}}">
                ...
                <td>
                    <form action="{{url('fichas/'.$ficha->IdFicha.'/edit')}}">
...
<head>
    ...
    <title>ProductivA - Instructores</title>
    <!-- This page css -->
    <!-- Custom CSS -->
    ...
    <!--[if lt IE 9]>
        ...
        <link rel="shortcut icon" href="assets_ficha/images/favicon.ico">

        <!-- App css -->
        <link href="assets_ficha/css/icons.min.css" rel="stylesheet" type="text/css">
        <link href="assets_ficha/css/app.min.css" rel="stylesheet" type="text/css" id="light-style">
        ...
        <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box">
                            <h4 class="page-title"> Fichas Programa de Formación </h4>
                        </div>
                    </div>
                </div>
                <!-- end page title -->
                ...
                <div class="row mb-2">
                    <div class="col-sm-4">
                        <a href="apps-projects-add.html" class="btn btn-danger btn-rounded mb-3"><i class="mdi mdi-plus"></i> Nueva Ficha </a>
                    </div>
                    <div class="col-sm-8">
                        <div class="text-sm-end">
                            ...
                            <div class="btn-group mb-3 ms-1">
                                <button type="button" class="btn btn-light">Activas</button>
                                <button type="button" class="btn btn-light">Inactivas</button>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="dropdown card-widgets">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end">
                                        ...
                                        <!-- item-->
                                        <a href="javascript:void(0);" class="dropdown-item"><i class="mdi mdi-delete me-1"></i>Estado</a>
                                        <!-- item-->
                                        <a href="javascript:void(0);" class="dropdown-item"><i class="mdi mdi-exit-to-app me-1"></i>ver</a>
                                    </div>
                                </div>
                                <!-- project title-->
                                <h4 class="mt-0">
                                    <a href="apps-projects-details.html" class="text-title">Programa: </a>
                                </h4>
                                <div class="badge bg-success mb-3">Estado</div>

                                <p class="text-muted font-13 mb-3"> Descripción... <a href="javascript:void(0);" class="fw-bold text-muted">view more</a>
                                </p>
                                ...
                                <div id="tooltip-container">
                                    <a href="javascript:void(0);" data-bs-container="#tooltip-container" data-bs-toggle="tooltip" data-bs-placement="top" title="Mat Helme" class="d-inline-block">
                                        <img src="assets_ficha/images/users/avatar-6.jpg" class="rounded-circle avatar-xs" alt="friend">
                                    </a>
                                    ...
                                    <a href="javascript:void(0);" data-bs-container="#tooltip-container" data-bs-toggle="tooltip" data-bs-placement="top" title="Michael Zenaty" class="d-inline-block">
                                        <img src="assets_ficha/images/users/avatar-7.jpg" class="rounded-circle avatar-xs" alt="friend">
                                    </a>
                                    ...
                                    <a href="javascript:void(0);" data-bs-container="#tooltip-container" data-bs-toggle="tooltip" data-bs-placement="top" title="James Anderson" class="d-inline-block">
                                        <img src="assets_ficha/images/users/avatar-8.jpg" class="rounded-circle avatar-xs" alt="friend">
                                    </a>
                    ...
                    <div class="col-md-6 col-xxl-3">
                        ...
                        <div class="card d-block">
                            <div class="card-body">
                                ...
                                <div class="badge bg-danger text-light mb-3">Estado</div>
                                ...
                                <div id="tooltip-container1">
                                    <a href="javascript:void(0);" data-bs-container="#tooltip-container1" data-bs-toggle="tooltip" data-bs-placement="top" title="Mat Helme" class="d-inline-block">
                                        <img src="assets_ficha/images/users/avatar-1.jpg" class="rounded-circle avatar-xs" alt="friend">
                                    </a>
                                    ...
                                    <a href="javascript:void(0);" data-bs-container="#tooltip-container1" data-bs-toggle="tooltip" data-bs-placement="top" title="Michael Zenaty" class="d-inline-block">
                                        <img src="assets_ficha/images/users/avatar-2.jpg" class="rounded-circle avatar-xs" alt="friend">
                                    </a>
                                    ...
                                    <a href="javascript:void(0);" data-bs-container="#tooltip-container1" data-bs-toggle="tooltip" data-bs-placement="top" title="James Anderson" class="d-inline-block">
                                        <img src="assets_ficha/images/users/avatar-3.jpg" class="rounded-circle avatar-xs" alt="friend">
                                    </a>
                                    <a href="javascript:void(0);" class="d-inline-block text-muted fw-bold ms-2">
                                        +3 more
                                    </a>
                            ...
                            <div class="card-body">
                                <div class="dropdown card-widgets">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end">
                                        ...
                                        <a href="javascript:void(0);" class="dropdown-item"><i class="mdi mdi-delete me-1"></i>Estado</a>
                                        <!-- item-->
                                        <a href="javascript:void(0);" class="dropdown-item"><i class="mdi mdi-email-outline me-1"></i>Ver</a>
                                    </div>
                                </div>
                                <!-- project title-->
                                <h4 class="mt-0">
                                ...
                                <div id="tooltip-container2">
                                    <a href="javascript:void(0);" data-bs-container="#tooltip-container2" data-bs-toggle="tooltip" data-bs-placement="top" title="Mat Helme" class="d-inline-block">
                                        <img src="assets_ficha/images/users/avatar-4.jpg" class="rounded-circle avatar-xs" alt="friend">
                                    </a>
                                    ...
                                    <a href="javascript:void(0);" data-bs-container="#tooltip-container2" data-bs-toggle="tooltip" data-bs-placement="top" title="Michael Zenaty" class="d-inline-block">
                                        <img src="assets_ficha/images/users/avatar-5.jpg" class="rounded-circle avatar-xs" alt="friend">
                                    </a>
                                </div>
                            </div> <!-- end card-body-->
                            <ul class="list-group list-group-flush">
                            ...
                            <div class="card-body">
                                ...
                                <div id="tooltip-container3">
                                    <a href="javascript:void(0);" data-bs-container="#tooltip-container3" data-bs-toggle="tooltip" data-bs-placement="top" title="Mat Helme" class="d-inline-block">
                                        <img src="assets_ficha/images/users/avatar-10.jpg" class="rounded-circle avatar-xs" alt="friend">
                                    </a>
                ...
                <div class="row">
                    <div class="col-md-6 col-xxl-3">
                        ...
                        <div class="card d-block">
                            <!-- project-thumbnail -->
                            <img class="card-img-top" src="assets_ficha/images/projects/project-1.jpg" alt="project image cap">
                            <div class="card-img-overlay">
                                <div class="badge bg-danger text-light p-1">Estado</div>
                            </div>
                            ...
                            <div class="card-body position-relative">
                                ...
                                <div class="mb-3" id="tooltip-container4">
                                    ...
                                    <a href="javascript:void(0);" data-bs-container="#tooltip-container4" data-bs-toggle="tooltip" data-bs-placement="top" title="James Anderson" class="d-inline-block">
                                        <img src="assets_ficha/images/users/avatar-9.jpg" class="rounded-circle avatar-xs" alt="friend">
                                    </a>
                                </div>
                    ...
                    <div class="col-md-6 col-xxl-3">
                        ...
                        <div class="card d-block">
                            <!-- project-thumbnail -->
                            <img class="card-img-top" src="assets_ficha/images/projects/project-2.jpg" alt="project image cap">
                            <div class="card-img-overlay">
                                <div class="badge bg-success p-1">Estado</div>
                            </div>
                    ...
                    <div class="col-md-6 col-xxl-3">
                        ...
                        <div class="card d-block">
                            <!-- project-thumbnail -->
                            <img class="card-img-top" src="assets_ficha/images/projects/project-3.jpg" alt="project image cap">
                            <div class="card-img-overlay">
                                <div class="badge bg-danger text-light p-1">Estado</div>
                            </div>
                    ...
                    <div class="col-md-6 col-xxl-3">
                        ...
                        <div class="card d-block">
                            <!-- project-thumbnail -->
                            <img class="card-img-top" src="assets_ficha/images/projects/project-4.jpg" alt="project image cap">
                            <div class="card-img-overlay">
                                <div class="badge bg-danger text-light p-1">Estado</div>
                            </div>
...
<!-- bundle -->
<script src="assets_ficha/js/vendor.min.js"></script>
