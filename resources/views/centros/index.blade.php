...
<button type="button" class="btn btn-primary"><a style="color:white;" type="submit" class=" btn btn-success" href="{{ url('centros/create') }}">Nuevo Centro</a></button>
    ...
    <tbody>
        @foreach ($centros as $centro)
            <tr>
                ...
                <td>
                    <form action="{{url('centros/'.$centro->IdCentro)}}">
                ...
                <td>
                    <form action="{{url('centros/'.$centro->IdCentro.'/edit')}}">
